...
public class DragFloatingActionButton extends FloatingActionButton {
    private static final String TAG = "DragFlatingActionButton";
    private float mX;
    private float mY;
    ...
    public DragFloatingActionButton(Context context, AttributeSet attrs, final int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.DragFloatinigActionButton);
        mScrollEnable = ta.getBoolean(R.styleable.DragFloatinigActionButton_scrollEnable, true);
        ta.recycle();
    }
    ...
    protected void onAttachedToWindow() {
        ...
        //防止布局重置时重置DragFlatingActionButton的位置
