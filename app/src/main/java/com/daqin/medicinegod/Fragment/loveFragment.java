...
public class loveFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        drawer = binding.idLoveDrawerlayout;
        navigationView = binding.navViewLove;
        ImageButton btn_more = binding.idLoveMore;
        ...
        navigationView.setCheckedItem(R.id.navigation_love_title);
