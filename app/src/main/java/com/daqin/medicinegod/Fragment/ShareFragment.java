...
import com.daqin.medicinegod.databinding.FragmentShareBinding;
...
public class ShareFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        drawer = binding.idShareDrawerlayout;
        navigationView = binding.navViewShare;
        ImageButton btn_more = binding.idShareMore;
        ...
        navigationView.setCheckedItem(R.id.navigation_share_title);
