...
public class RxFragment extends Fragment {
    ...
    private FragmentRxBinding binding;
    View root;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        drawer = binding.idRxDrawerlayout;
        navigationView = binding.navViewRx;
        ImageButton btn_more = binding.idRxMore;
        ...
        navigationView.setCheckedItem(R.id.navigation_rx_title);
