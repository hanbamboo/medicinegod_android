...
public class NearFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        drawer = binding.idNearDrawerlayout;
        navigationView = binding.navViewNear;
        ImageButton btn_more = binding.idNearMore;
        ...
        navigationView.setCheckedItem(R.id.navigation_near_title);
