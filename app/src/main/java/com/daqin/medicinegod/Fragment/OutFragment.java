...
import com.daqin.medicinegod.databinding.FragmentNearBinding;
...
public class OutFragment extends Fragment {
    ...
    private FragmentOutBinding binding;
    View root;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        drawer = binding.idOutDrawerlayout;
        navigationView = binding.navViewOut;
        ImageButton btn_more = binding.idOutMore;
        ...
        navigationView.setCheckedItem(R.id.navigation_out_title);
