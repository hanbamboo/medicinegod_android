...
import com.daqin.medicinegod.databinding.FragmentOtcnullBinding;
import com.google.android.material.navigation.NavigationView;

import java.util.HashMap;
import java.util.Map;

public class OtcNullFragment extends Fragment {

    private FragmentOtcnullBinding binding;
    View root;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentOtcnullBinding.inflate(inflater, container, false);
        root = binding.getRoot();

        drawer = binding.idOtcnullDrawerlayout;
        navigationView = binding.navViewOtcnull;
        ImageButton btn_more = binding.idOtcnullMore;
        ...
        navigationView.setCheckedItem(R.id.navigation_otcnull_title);
