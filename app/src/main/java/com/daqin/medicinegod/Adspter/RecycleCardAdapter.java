 ...
 */
public class RecycleCardAdapter extends BaseAdapter {

    private LayoutInflater layoutInflater;
    int resourcesid;
    static List<Map<String, Object>> medicines = new ArrayList<>();

    public RecycleCardAdapter(Context context, int resourcesid, List<Map<String, Object>> medicines) {
        ...
        if (fromweb == 0) {
            ...
            switch (res) {
                case -1:
                    ...
                    viewHolder.id_card_view.setBackground(ResourcesCompat.getDrawable(convertView.getContext().getResources(),
    ...
    public class ViewHolder {
        ...
        public final LinearLayout id_card_view;
        ...
        public ViewHolder(View root) {
            ...
            id_card_view = (LinearLayout) root.findViewById(R.id.id_card_view);
